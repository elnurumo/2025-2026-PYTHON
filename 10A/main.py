...
# # a = 'salam necesen' # str ---> list
# # # a = a.split()
# # a = list(a)
# # print(a)


# # a = [14,25,30,2,40,3,36]
# # maximum = a[0]
# # for i in a:
# #     if i>maximum:
# #         maximum = i
...
# #         print('IV')
# # else:
# #     print('x ve y 0dan ferqli olsun')
...
# # n = input()
# # rqmlr = [int(i) for i in n]
# # print(sum(rqmlr)-max(rqmlr))
...
# L = [342,123,576,163,2,101]
# s = 0
# for i in L:
#     if 99<i<1000 and simpleOrCompound(i) == 0:
#         s = s + i
# print(s)

# # 127

# n = input() # "Oğuz Məmmədli"
# n = n.split() # ['Oğuz', "Məmmədli"]
# for i in n:
#     print(len(i))
...
# l=[]
# for i in range (0,n):
#     c = int(input(f'1-ci listin {i+1}.element: '))
#     d = int(input(f'2-ci listin {i+1}.element: '))
#     s = c+d
#     l.append(s)
# print(l)
...
# n = input().split() # salam necesen--->['salam','necesen']
# print(len(n))
...
#     s = i.count('w')
#     j = j+1
#     print('daxil edilmiş cümlənin',j,'saylı sözündə',s,'sayda w simvolu mövcuddur')
#     print('daxil edilmiş cümlənin '+str(j)+' saylı sözündə '+str(s)+' sayda w simvolu mövcuddur')
#     print(f'daxil edilmiş cümlənin {j} saylı sözündə {s} sayda w simvolu mövcuddur')
...
# n = input().split() # ['salam', 'necesen', 'Murad']
# s = 0
# for i in n:
#     if i.count('s') != 0:
#         s += 1
...
# b= []
# for i in range(n) :
#     a=int(input()) # [113 114 115 ]
#     b.append(a)
# for i in b:
#     # print((i%10)*(i//10**(len(str(i))-1)))
#     i = str(i)
#     h = int(i[0])*int(i[-1])
#     print(h)
...
# n = int(input()) # 1385 ---> 5381  5381-1385 = 3996
# n = str(n) # '1385'
# k = n[1:len(n)-1] # '38'
# a = n[0] # '1'
# b = n[-1] # '5'
...
# c = []
# for i in n:
#     if n.count(m) == 3 and i != m:
#         c.append(i)
#     elif n.count(m) == 2 and i != m:
#         c.append(i)
#     else: 
#         c = n
...
# # 156
# aylar = ['yanvar','fevral','mart','aprel','may','iyun']
# b = []
# for i in aylar:
#     x = int(input())
#     b.append(x)
